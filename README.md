...
9 条 INFO **全部**是探针在说「我没测出来」，没有一条被写成指控：

| 编号 | 工具实际说了什么 |
|---|---|
| `rel-clean` | 6/6 成功，中位延迟 0.72 秒 |
...
| `params-103` | 2 项样本为空——**空回复不等于参数被忽略** |
...
`CRITICAL=0 HIGH=0 MEDIUM=0 LOW=0 INFO=13`，退出码 `0`。它的面板自报加价倍率 1.0x，
上游成本与计费金额逐项相等，可用性 6/6。
